...
function formatAbbreviatedNumber($num)
{
    ...
    // Helper to truncate instead of rounding
    $truncate = function ($value) {
        return floor($value * 100) / 100; // keeps 2 decimals without rounding up
    };

    if ($abs >= 1_000_000_000_000) {
        return $truncate($num / 1_000_000_000_000) . 'T';
    }
...
function execStoredProcedure(PDO $pdo, string $sql, array $params): array
{
