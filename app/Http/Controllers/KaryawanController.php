...
class KaryawanController extends Controller
{
    ...
    public function create()
    {
        ...
        $data['regions'] = Regions::orderBy('nama_region')->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($jabatan && str_starts_with(strtolower($jabatan->nama_jabatan), 'regional')) {
            $request->validate([
    ...
    public function show($nik)
    {
        ...
        $karyawan = Karyawan::where('karyawan.nik', $nik)
            ...
            ->leftJoin('regions', 'karyawan.kode_region', '=', 'regions.kode_region')
            ->select(
                'karyawan.*',
                'cabang.nama_cabang',
