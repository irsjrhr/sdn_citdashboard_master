...
class CITDashboard_model extends Model{

    //+++++++++++++++++++++++++++++++++++++ METHOD BUILDER +++++++++++++++++++++++++++++++++++

    //Method untuk membuat datasets dengan format bank in dan cash in di satu grafik yang sama
    public function build_dataGrafik_cohBankIn( $data_grafik_cohBankIn = [] ) : array{
    ...
    //Method untuk membuat data COH BANK IN Berdasarkan filter
    public function build_datasetCOHBankIn( $filters ){
    ...
    public function get_last_updateCIT(){
    ...
    public function build_filterDate ( Request $request ) : array {
    ...
    public function build_filterData( Request $request ) :array {
    ...
    public function build_datasetGrafik( $datasets_grafik = [], $key_label_row, $option_build = [] ) : array{
    ...
    public function build_header_table( $data_teritory, $data_driversales, $data_customer ){
